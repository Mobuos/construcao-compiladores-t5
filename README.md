...
Quarto trabalho da disciplina de Construção de Compiladores, lecionada pelo professor Daniel Lucrédio.
...
Para compilar e executar o programa basta executar os comandos a seguir, a partir da pasta `t4-semantico`.
...
```bash
  java -jar target/t4-semantico-1.0-SNAPSHOT-jar-with-dependencies.jar <caminho para o código fonte LA> [caminho para arquivo de saída]
```
